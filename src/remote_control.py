...
def run_server() -> None:
    ...
    # FIXME: `SOCK_STREAM` er TCP protokol.
    #  Den kan ændres til `socket.SOCK_DGRAM` for at bruge UDP (user DataGRAM protocol).
    #  Men så skal der nok også rettes til, andre steder i koden.
